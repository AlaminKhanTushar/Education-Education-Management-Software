...
class TeacherController extends Controller
{
    ...
    public function updateStatus($id)
    {
        ...
        if ($this->teacher->status == 1)
        {
            ...
            $this->message = 'Teacher status info Active successfully. ';
        }
        else
        {
            $this->teacher->status = 1;
            $this->message = 'Teacher status info Inactive successfully. ';
        }
        $this->teacher->save();
        return redirect('/manage-teacher')->with('message', $this->message);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/manage-teacher')->with('jsAlert', 'Teacher info update successfully.');
    }
    ...
    {
        $this->teacher = Teacher::find($id);
        return view('admin.teacher.detail',['teacher' => $this->teacher]);
    }
}
